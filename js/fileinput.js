...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="kv-caption-icon"><i class="fa fa-file-image-o"></i> </span>',
    ...
    $.fn.fileinput.defaults = {
        ...
        dropZoneTitle: 'Agrega imagenes aquí &hellip;',
