...
class Nuevanota extends CI_Controller {
  ...
  public function nota_columna($contenido,$tipo_nota,$url_video,$redaccion,$columna_id,$autor)
  {
		$columna = $this->columna_model->get_all_columna($columna_id);
    $nombre = $columna->nombre;
    $imagen_nota = $columna->imagen_columna;
		$nota_id = $this->nota_model->crearNotaColumna($nombre,$contenido,$tipo_nota,$imagen_nota,$url_video,$redaccion,$columna_id);
  ...
  public function nota_galeria($nombre,$contenido,$tipo_nota,$url_video,$redaccion,$galeria_id,$secciones,$autor)
  {
      $imagen_nota = $this->galeria_model->getRouteFirstElement($galeria_id)[0]->ruta_imagen;
      $nota_id = $this->nota_model->crearNotaGaleria($nombre,$contenido,$tipo_nota,$imagen_nota,$url_video,$redaccion,$galeria_id);
